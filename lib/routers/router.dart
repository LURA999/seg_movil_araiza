...
class Routers {
  ...
  static final routerMain = {
    ...
    /* scanner_qr_assistance */ namesRouter[3].toList()[13] : ( _ ) => const CustomBackBvuttonInterceptor(child:ScannerQR()),
    /* scanner_qr_food*/ namesRouter[3].toList()[14] : ( _ ) => const CustomBackBvuttonInterceptor(child:ScannerQR()),
    ...
    /* tour_seh_tr1_d */ namesRouter[3].toList()[3] : ( _ ) => const CustomBackBvuttonInterceptor(child:QuestRoute()),
    /* tour_seh_tr2_a */ namesRouter[3].toList()[4] : ( _ ) => const CustomBackBvuttonInterceptor(child:QuestRoute()),
    /* tour_seh_tr2_b */ namesRouter[3].toList()[5] : ( _ ) => const CustomBackBvuttonInterceptor(child:QuestRoute()),
    /* tour_seh_tr2_c */ namesRouter[3].toList()[6] : ( _ ) => const CustomBackBvuttonInterceptor(child:QuestRoute()),
    /* tour_seh_tr3_a */ namesRouter[3].toList()[7] : ( _ ) => const CustomBackBvuttonInterceptor(child:QuestRoute()),
    /* tour_seh_tr3_b */ namesRouter[3].toList()[8] : ( _ ) => const CustomBackBvuttonInterceptor(child:QuestRoute()),
    /* tour_seh_tr3_c */ namesRouter[3].toList()[9] : ( _ ) => const CustomBackBvuttonInterceptor(child:QuestRoute()),
    /* tour_seh_tr4_a */ namesRouter[3].toList()[10] : ( _ ) => const CustomBackBvuttonInterceptor(child:QuestRoute()),
    /* tour_seh_tr4_b */ namesRouter[3].toList()[11] : ( _ ) => const CustomBackBvuttonInterceptor(child:QuestRoute()),
    /* tour_seh_tr4_c */ namesRouter[3].toList()[12] : ( _ ) => const CustomBackBvuttonInterceptor(child:QuestRoute())
